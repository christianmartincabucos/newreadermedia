                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-4">
                                            <a href="{{ $data->url }}" rel="nofollow">
                                                @if($data->image != '')
                                                <img src="{{ asset('public/public/storage/blogs/newsletter/'.$data->image) }}" style="position:relative;width:100%;overflow:hidden;margin-bottom:10px">
                                                @else
                                                <img src="{{ asset('public/public/storage/nrmedia-logo2.png') }}" style="position:relative;width:100%;overflow:hidden;margin-bottom:10px">
                                                @endif
