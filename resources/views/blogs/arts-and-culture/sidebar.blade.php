<div class="col-md-3">
    ...
    <ul class="" style="padding-left:20px">
        <li><a href="{{ url('blogs/arts-and-culture/greatest-cons-in-history') }}" class="article-link">Greatest Cons in History</a></li>
        <li><a href="{{ url('blogs/arts-and-culture/aphantasia') }}" class="article-link">Aphantasia</a></li>    
        ...
        <li class="hidden"><a href="{{ url('http://weightlossbible.net/2018/10/12/the-top-weight-loss-scams-in-the-world/') }}" class="article-link" target="_blank" rel="nofollow">The Top Weight Loss Scams in the World</a></li>
