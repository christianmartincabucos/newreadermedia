                    ...
                    <section class="box-section">
                        ...
                        <div class="col-md-9 text-justify right-divider">
                            <div class="col-md-4 center-block">
                                <img src="{{{ url('public/storage/featured-author/lindy-kerr.jpg') }}}" class="img-circle" style="width:100%">
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-8 center-block">
                                    <a href="https://www.amazon.com/GodS-Amazing-Creation-Story-Seeds-ebook/dp/B079N4GM87/" target="_blank" rel="nofollow">
                                        <img src="{{{ url('public/storage/featured-author/gods-amazing-creation.png') }}}" class="" style="width:100%">
                                    </a>
                                </div>
