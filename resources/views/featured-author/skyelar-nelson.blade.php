                    ...
                    <section class="box-section">
                        ...
                        <div class="col-md-9 text-justify right-divider">
                            <div class="col-md-4 center-block">
                                <img src="{{{ url('public/storage/featured-author/skyelar-nelson.jpg') }}}" class="img-circle" style="width:100%">
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-8 center-block">
                                    <a href="https://www.amazon.com/Payless-Skyelar-Nelson/dp/148083419X/" target="_blank" rel="nofollow">
                                        <img src="{{{ url('public/storage/featured-author/payless.png') }}}" class="" style="width:100%">
                                    </a>
                                </div>
