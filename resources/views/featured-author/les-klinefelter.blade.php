                    ...
                    <section class="box-section">
                        ...
                        <div class="col-md-9 text-justify right-divider">
                            <div class="col-md-4 center-block">
                                <img src="{{{ url('public/storage/featured-author/les-klinefelter.jpg') }}}" class="img-thumbnail" style="width:100%">
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-8 center-block">
                                    <a href="https://www.amazon.com/Why-Effective-Communication-Self-Awareness/dp/1478796065/" target="_blank" rel="nofollow">
                                        <img src="{{{ url('public/storage/featured-author/why-me.png') }}}" class="" style="width:100%">
                                    </a>
                                </div>
