                    ...
                    <section class="box-section">
                        ...
                        <div class="col-md-9 text-justify right-divider">
                            <div class="col-md-4 center-block">
                                <img src="{{{ url('public/storage/featured-author/lawrence-stenzel.jpg') }}}" class="img-circle" style="width:100%">
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-8 center-block">
                                    <a href="https://www.amazon.com/Tale-Tail-Nine-Stars-Odyssey/dp/1546242538/" target="_blank" rel="nofollow">
                                        <img src="{{{ url('public/storage/featured-author/a-tale-of-the-tail-of-nine-stars.png') }}}" class="" style="width:100%">
                                    </a>
                                </div>
