                    ...
                    <section class="box-section">
                        ...
                        <div class="col-md-9 text-justify right-divider">
                            <div class="col-md-4 center-block">
                                <img src="{{{ url('storage/featured-author/zachary-zeigler.jpg') }}}" class="img-circle" style="width:100%">
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-8 center-block">
                                    <a href="https://www.amazon.com/Weight-Loss-Bible-Scientific-Approach-ebook/dp/B079ZJTQCM/ " target="_blank" rel="nofollow">
                                        <img src="{{{ url('storage/featured-author/weight-loss-bible.png') }}}" class="" style="width:100%">
                                    </a>
                                </div>
