            ...
            <tr>
              <td align="center" valign="top">
                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                  <tr>
                    <td align="center" valign="top" style="background:#000">
                      {{-- Grid One --}}
              ...
              <td align="center" valign="top">
                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                  <tr>
                    <td align="center" valign="top">
                      {{-- Grid One --}}
                      <p style="font-family:sans-serif;color:#222;text-align:justify">New Reader Media is a marketing and publicity firm for enterprising creatives, artists, and independent authors. We also offer film-to-screen literary agent services and filmmaking services for authors who want to break into the world of film and television.</p>
                    </td>
                  </tr>
                </table>
